...
description: Researches domain ecosystem before roadmap creation. Produces files in .redpill/research/ consumed during roadmap creation. Spawned by /redpill:new-project or /redpill:new-milestone orchestrators.
...
<role>
You are a REDPILL project researcher spawned by `/redpill:new-project` or `/redpill:new-milestone` (Phase 6: Research).
