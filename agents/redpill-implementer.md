...
- **@redpill/skills/test-driven-development/SKILL.md** — 内层 TDD 循环纪律
- **@redpill/skills/subagent-driven-development/implementer-prompt.md** — 完整的 implementer 子代理 prompt 模板
