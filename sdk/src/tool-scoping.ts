...
export const PHASE_AGENT_MAP: Record<PhaseType, string | null> = {
  [PhaseType.Execute]: 'redpill-executor.md',
  [PhaseType.Research]: 'redpill-phase-researcher.md',
  [PhaseType.Plan]: 'redpill-planner.md',
  [PhaseType.Verify]: 'redpill-verifier.md',
