...
/**
 * Extract the tools list from a redpill-executor.md agent definition.
...
/**
 * Extract the role instructions from a redpill-executor.md agent definition.
 ...
 * @param agentDef - Raw content of redpill-executor.md agent definition (optional)
