...
Instead, please report them via email to: **security@redpill.dev** (or DM @jinrunsen on Discord/Twitter if email bounces)
...
Security issues in the REDPILL codebase that could:
