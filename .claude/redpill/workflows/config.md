...
```bash
node "/Users/jinrunsen/Projects/github/redpill/.claude/redpill/bin/redpill-tools.cjs" config-ensure-section
INIT=$(node "/Users/jinrunsen/Projects/github/redpill/.claude/redpill/bin/redpill-tools.cjs" state load)
