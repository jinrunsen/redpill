...
node "/Users/jinrunsen/Projects/github/redpill/.claude/redpill/bin/redpill-tools.cjs" commit "docs: start work on todo - [title]" --files .redpill/todos/done/[filename] .redpill/STATE.md
```
