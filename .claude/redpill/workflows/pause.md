...
```bash
timestamp=$(node "/Users/jinrunsen/Projects/github/redpill/.claude/redpill/bin/redpill-tools.cjs" current-timestamp full --raw)
```
...
<step name="commit">
```bash
node "/Users/jinrunsen/Projects/github/redpill/.claude/redpill/bin/redpill-tools.cjs" commit "wip: [phase-name] paused at task [X]/[Y]" --files .redpill/phases/*/.continue-here.md .redpill/HANDOFF.json
```
</step>
