...
describe('execute-phase.md context enrichment', () => {
  const EXECUTE_WORKFLOW_PATH = path.join(__dirname, '..', 'redpill', 'workflows', 'execute-phase.md');
...
describe('plan-phase.md context enrichment', () => {
  const PLAN_WORKFLOW_PATH = path.join(__dirname, '..', 'redpill', 'workflows', 'plan-phase.md');
