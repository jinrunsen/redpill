...
const { scanForInjection, INJECTION_PATTERNS } = require('../redpill/bin/lib/security.cjs');
...
const ALLOWLIST = new Set([
  'redpill/bin/lib/security.cjs',        // The security module itself
  'hooks/redpill-prompt-guard.js',                  // The prompt guard hook
