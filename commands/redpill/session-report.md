...
<execution_context>
@~/.claude/redpill/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @~/.claude/redpill/workflows/session-report.md end-to-end.
</process>
