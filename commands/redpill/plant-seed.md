...
Creates: .redpill/seeds/SEED-NNN-slug.md
Consumed by: /redpill:new-milestone (scans seeds and presents matches)
</objective>

<execution_context>
@~/.claude/redpill/workflows/plant-seed.md
</execution_context>

<process>
Execute the plant-seed workflow from @~/.claude/redpill/workflows/plant-seed.md end-to-end.
</process>
