...
| [CLI Tools Reference](CLI-TOOLS.md) | Contributors, agent authors | `redpill-tools.cjs` programmatic API for workflows and agents |
...
- **Getting started:** [README](../README.md) → install → `/redpill:new-project`
