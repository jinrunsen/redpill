...
Redpill 프레임워크의 종합 문서입니다. Redpill은 AI 코딩 에이전트를 위한 메타 프롬프팅, 컨텍스트 엔지니어링, 스펙 기반 개발 시스템입니다.
...
| [CLI Tools Reference](CLI-TOOLS.md) | 기여자, 에이전트 작성자 | 워크플로우 및 에이전트를 위한 `redpill-tools.cjs` 프로그래매틱 API |
...
- **시작하기:** [README](../README.md) → 설치 → `/redpill:new-project`
