...
| [Ferramentas CLI](CLI-TOOLS.md) | Contribuidores, autores de agentes | API programática `redpill-tools.cjs` |
...
- **Começar rápido:** [README principal](../../README.pt-BR.md) -> instalação -> `/redpill:new-project`
