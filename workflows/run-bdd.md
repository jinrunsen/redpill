...
loop:
  ...
  if result 中有 undefined steps:
    spawn Agent(redpill-step-writer)
      注入: @redpill/skills/bdd-step-writer/SKILL.md
  ...
  spawn Agent(redpill-implementer)
    注入: @redpill/skills/subagent-driven-development/implementer-prompt.md
           + @redpill/skills/test-driven-development/SKILL.md
    上下文: {
