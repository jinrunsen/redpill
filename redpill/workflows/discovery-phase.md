...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /redpill:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/redpill/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/redpill/templates/discovery.md structure:
...
**Output:** `.redpill/phases/XX-name/DISCOVERY.md`
</step>
...
1. **Scope the discovery** using ~/.claude/redpill/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/redpill/templates/discovery.md
...
**Output:** `.redpill/phases/XX-name/DISCOVERY.md` (comprehensive)
</step>
...
Use ~/.claude/redpill/templates/discovery.md.
...
Write `.redpill/phases/XX-name/DISCOVERY.md`:
- Summary with recommendation
...
```
Discovery complete: .redpill/phases/XX-name/DISCOVERY.md
Recommendation: [one-liner]
Confidence: [level]

What's next?

1. Discuss phase context (/redpill:discuss-phase [current-phase])
2. Create phase plan (/redpill:plan-phase [current-phase])
