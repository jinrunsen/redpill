...
**Work on it now:**
```bash
mv ".redpill/todos/pending/[filename]" ".redpill/todos/completed/"
```
...
node "$HOME/.claude/redpill/bin/redpill-tools.cjs" commit "docs: start work on todo - [title]" --files .redpill/todos/completed/[filename] .redpill/STATE.md
```
