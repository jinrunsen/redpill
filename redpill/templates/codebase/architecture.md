...
Template for `.redpill/codebase/ARCHITECTURE.md` - captures conceptual code organization.
...
1. User runs: `redpill new-project`
...
**State Management:**
- File-based: All state lives in `.redpill/` directory
...
- Triggers: User runs `redpill <command>`
