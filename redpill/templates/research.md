...
Template for `.redpill/phases/XX-name/{phase_num}-RESEARCH.md` - comprehensive ecosystem research before planning.
...
**CRITICAL:** If CONTEXT.md exists from /redpill:discuss-phase, copy locked decisions here verbatim. These MUST be honored by the planner.
...
**Structure:**
- Use XML tags for section markers (matches REDPILL templates)
...
**After creation:**
- File lives in phase directory: `.redpill/phases/XX-name/{phase_num}-RESEARCH.md`
